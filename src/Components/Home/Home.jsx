  ...
  return (
    <div className={styles.homepageconteiner}>
      <div className={styles.welcometoAbc}>
        ...
        <p>
          Where history meets style. Based in the heart of Prague, we specialize
          in curating a unique collection of authentic vintage treasures that
          add charm and character to any space or wardrobe.
        </p>
      </div>
